...
dnf install --assumeyes coreutils git make python tar which bzip2 ncurses gmp-devel mpfr-devel libmpc-devel glibc-devel flex bison glibc-static zlib-devel gcc gcc-c++ nodejs npm &&
    mkdir /opt/scarecrowtasty/c9sdk &&
    chmod 0555 /opt/scarecrowtasty/c9sdk &&
    git -C /opt/scarecrowtasty/c9sdk init &&
    git -C /opt/scarecrowtasty/c9sdk remote add origin git://github.com/c9/core.git &&
    git -C /opt/scarecrowtasty/c9sdk pull origin master &&
    /opt/scarecrowtasty/c9sdk/scripts/install-sdk.sh &&
