...
export CANONICAL_URL=ssh://git@gitlab.363-283.io:2252/emory.merryman/richyard.git &&
export ORIGIN_URL=ssh://git@gitlab.363-283.io:2252/emory.merryman/richyard.git &&
